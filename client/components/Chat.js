...
function Chat({ navigate, selectedPairner }) {
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      // await apiService.chat.sendMessage(activeConversation.id, newMessage);
      ...
      <div className="chat-quick-actions">
        <div className="quick-action-card">
          ...
          <div className="quick-action-content">
            ...
            <p>Set up a meeting with your selected au pair</p>
          </div>
          <button className="btn btn-outline btn-sm" onClick={() => navigate('meetings')}>
            Schedule
          </button>
        </div>
        ...
        <div className="quick-action-card">
          ...
          <div className="quick-action-content">
            <h4>View Profile</h4>
            <p>See detailed information about the au pair</p>
          </div>
          <button className="btn btn-outline btn-sm" onClick={() => navigate('pairner', activeConversation)}>
            View
          </button>
        </div>
      </div>
